...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleResourceNotFound(
        ...
        ApiError apiError = new ApiError("User Not Found", HttpStatus.NOT_FOUND, null);
    ...
    protected ResponseEntity<Object> handleAuthorizeError(UnauthorizedError ex) {
        ApiError apiError = new ApiError("User is not authorized", HttpStatus.UNAUTHORIZED, null);
        apiError.setMessage(ex.getMessage());
